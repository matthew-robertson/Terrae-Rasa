...
public class EntityLivingNPC extends EntityLiving 
{
	...
	//npc declarations
	public static EntityLivingNPC test = (EntityLivingNPC) new EntityLivingNPC(0, "Test").setIsAlert(true).setTexture(Render.dino).setBaseSpeed(2.5f).setSpeech(new String[] { "Hai!", "I am a test NPC.", "I can't give you any quests."}).setUpwardJumpHeight(30).setJumpSpeed(6);
}
