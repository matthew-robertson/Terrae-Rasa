...
{	
	...
	{	
		...
		if(Dimensia.initInDebugMode)
		{
			...
			{
				world.player.launchProjectile( world, world.player.x, world.player.y, Item.snowball);
			...
			{
	        	world.player.launchProjectile( world, world.player.x, world.player.y, Item.magicMissileSpell);
	        ...
	        if(Keyboard.isKeyDown(Keyboard.KEY_P)) //Broken
	        {
	        	...
	        	EntityNPC enemy = EntityNPC.test.clone();
