		...
		implements Cloneable 
{
	...
	protected Block(int i)
	{
		...
		if (blocksList[id] != null) {
			System.out.println(new StringBuilder().append("Conflict@ BlockID ")
					.append(id).toString());
			throw new RuntimeException(new StringBuilder()
					.append("Conflict@ BlockID ").append(id).toString());
		}
		blocksList[id] = this;
	}
	...
	// Backwalls
	public static Block backAir = new BlockBackWall(128).setIconIndex(3, 0)
			.setName("backwall air");
	public static Block backDirt = new BlockBackWall(129)
