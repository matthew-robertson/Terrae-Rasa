...
public class EntityPlayer extends EntityLiving
{
	...
	public EntityPlayer(String name, EnumDifficulty difficulty)
	{
		...
		inventory.pickUpItemStack(new ItemStack(Item.copperSword));
		inventory.pickUpItemStack(new ItemStack(Item.copperPickaxe));
		inventory.pickUpItemStack(new ItemStack(Item.copperAxe));
		inventory.pickUpItemStack(new ItemStack(Block.craftingTable));
		selectedRecipe = 0;
		knockbackModifier = 1;
	...
	{			
		...
		else //Otherwise they actually have died
		{
			...
			Dimensia.dimensia.world.spawnPlayer(this);
		}
	}
	...
	public void breakBlock (World world, int mx, int my, Item item)
	{
		...
		{ //If the left-mouse button is pressed && they have the correct tool to mine
			...
			double distance = MathHelper.distanceBetweenTwoPoints((MathHelper.getCorrectMouseXPosition() + Render.getCameraX()), (MathHelper.getCorrectMouseYPosition() + Render.getCameraY()), (this.x + ((world.player.isFacingRight) ? 9 : 3)), (this.y + 9));
