...
public class AIManager {
	 ...
	 */
	public static void AIProjectile(WorldServerEarth world, EntityNPC npc, int angle, EntityProjectile projectile){
		world.launchProjectile(angle, projectile, npc.x, npc.y);
	 ...
	 * @param projectile - projectile to launch
	 */
	public static void AIProjectile(WorldServerEarth world, EntityNPC npc, int x, int y, EntityProjectile projectile){
