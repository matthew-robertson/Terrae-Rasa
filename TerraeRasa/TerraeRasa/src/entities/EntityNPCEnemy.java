...
{	
	...
	public final static EntityNPCEnemy goblin = new EntityNPCEnemy(0, "Goblin").setIsAlert(true).setSpawnVector("forest", " ").setSpawnVector("desert", "night").setTexture(Render.goblin).setDamageDone(7).setMaxHealth(50).setDrops(new MonsterDrop[] { 
			new MonsterDrop(new ItemStack(Item.coal), 1, 2, 5), new MonsterDrop(new ItemStack(Item.healthPotion1), 1, 2, 20)
	});
	public final static EntityNPCEnemy zombie = new EntityNPCEnemy(1, "zombie").setIsAlert(true).setSpawnVector(" ", "night").setDamageDone(16).setMaxHealth(60).setTexture(Render.zombie).setDrops(new MonsterDrop[]{
	...
	public final static EntityNPCEnemy slime = new EntityNPCEnemy(2, "Slime").setIsAlert(true).setSpawnVector(" ", " ").setBlockAndWorldDimensions(1,1).setTexture(Render.slime).setMaxHealth(30).setDamageDone(4).setBaseSpeed(1.4f).setDrops(new MonsterDrop[]{
	...
	public final static EntityNPCEnemy dino = new EntityNPCEnemy(3, "Dinosaur").setIsAlert(true).setSpawnVector("forest", "night").setBlockAndWorldDimensions(5,4).setTexture(Render.dino).setMaxHealth(150).setDamageDone(20).setBaseSpeed(3.4f).setDrops(new MonsterDrop[]{
