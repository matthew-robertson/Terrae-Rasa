...
{	
	public void render(World world, List<EntityPlayer> players, EntityPlayer activePlayer)
	{
		...
		Chunk[] chunks = ChunkUtils.getRequiredChunks(world, activePlayer);
