 ...
 * @since       1.0
 */
public class menucopy extends Render
{
...
//		totalWorlds = fileManager.getTotalWorlds(); //update world count
	...
	private void mouseClicks(int buttonPushed)
	{
		...
		{
			TerraeRasa.done = true; //Essentially calls System.exit();
		}
		//Play Menu:
...
//		worldNames = fileManager.getWorldFileNames(); //Get world names
	...
	{
		GL11.glColor4f(1, 1, 1, 1);
		trueTypeFont.drawString(0, (Display.getHeight() / 2) - 20, TerraeRasa.getVersion(), 0.5f, -0.5f, TrueTypeFont.ALIGN_LEFT);
	}
}