...
{		
	 ...
	 */
	public static Vector2 toRectangular(double magnitude, double angle){		
	...
	{
		//Vf = Vi + at
		double d = Vi + g * (ticksFallen / MPGameLoop.TICKS_PER_SECOND);
		return d;
	}	
	...
	{
		//Vf = Vi + at
		return Vi + a * (timeTicks / MPGameLoop.TICKS_PER_SECOND);
	}	
