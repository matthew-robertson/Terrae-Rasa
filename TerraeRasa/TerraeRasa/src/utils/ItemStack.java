		...
		implements Serializable
{
	...
	public ItemStack(int id, int stackSize)
	{
		...
		{
			itemName = Block.blocksList[id].getName();
			maxStackSize = Block.blocksList[id].getMaxStackSize();
		...
		{
			itemName = Item.itemsList[id].getName();
			maxStackSize = Item.itemsList[id].getMaxStackSize();			
			gemSockets = new GemSocket[Item.itemsList[id].getTotalSockets()];
		}		
		else
		{
			itemName = Spell.spellList[id].getName();
			maxStackSize = Spell.spellList[id].getMaxStackSize();
