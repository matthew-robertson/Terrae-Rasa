		...
		implements IEntityTransmitBase
{
	...
	@Override
	public void removeSingleArmorItem(ItemArmor itemArmor, ItemStack oldStack, int index) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void applySingleArmorItem(ItemArmor itemArmor, ItemStack newStack, int index) {
		// TODO Auto-generated method stub
