...
import client.hardware.LegalKeypresses;
...
public class GuiChatbox extends GuiComponent
{
	...
	public void drawPartially()
	{
		...
		for(int i = 0; i < lines.size(); i++)
		{
			...
			if(lines.get(invertedIndex).ticksLeft >= 0)
			{
				...
				GL11.glColor4d(EnumColor.GRAY.getColors()[0], EnumColor.GRAY.getColors()[1], EnumColor.GRAY.getColors()[2], 0.7);
				t.startDrawingQuads();		
				...
				GL11.glColor4d(lines.get(invertedIndex).color.getColors()[0], 
						lines.get(invertedIndex).color.getColors()[1], 
						lines.get(invertedIndex).color.getColors()[2], 1.0);
	...
	public void draw() 
	{
		...
		GL11.glColor4d(EnumColor.DARK_GRAY.getColors()[0], EnumColor.DARK_GRAY.getColors()[1], EnumColor.DARK_GRAY.getColors()[2], 0.8);
		t.startDrawingQuads();		
	    t.addVertexWithUV(x, y + height, 0, 0, 1);
	    t.addVertexWithUV(x + width, y + height, 0, 1, 1);
