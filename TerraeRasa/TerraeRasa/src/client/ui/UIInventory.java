...
public class UIInventory extends UIBase 
{
	...
	protected static ItemStack getMouseoverChestStack(WorldClientEarth world, EntityPlayer player, int mouseX, int mouseY)
	{
	 ...
	 */
	protected static void renderChest(WorldClientEarth world, EntityPlayer player)
	{
		//Get the initial block the player is viewing
		Block block = world.getAssociatedBlock(player.viewedChestX, player.viewedChestY);
		if(!(block instanceof BlockChest))
	 ...
	 */
	protected static void renderActionBar(WorldClientEarth world, EntityPlayer player) 
	{		
	 ...
	 */
	protected static void renderInventory(WorldClientEarth world, EntityPlayer player) 
	{
	 ...
	 */
	protected static void populateInventorySlots(WorldClientEarth world, EntityPlayer player) 
	{
		GL11.glColor4f(1, 1, 1, 1);
	...
	protected static void placeOneItemIntoInventory(ClientUpdate update, WorldClientEarth world, EntityPlayer player, int whichInventory, int index)
	{
	 ...
	 */
	protected static void placeItemIntoInventory(ClientUpdate update, WorldClientEarth world, EntityPlayer player, int whichInventory, int index)
	{
		shouldDropItem = false;
	 ...
	 */
	protected static void renderScrollableCraftingRecipeWheel(WorldClientEarth world, EntityPlayer player)
	{
		actionbarSlot.bind();
		GL11.glColor4f(1, 1, 1, 0.6f);
		int size;
