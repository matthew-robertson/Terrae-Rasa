...
{	
	 ...
	 */
	private static ItemStack getTooltipStack(WorldClientEarth world, EntityPlayer player, int mouseX, int mouseY)
	{	
		int index = -1;
		//Inventory
...
//			}
	...
	private static boolean[] getActiveBonuses(EntityPlayer player, ItemStack stack)
	{
		if(stack.getItemID() >= Item.itemIndex && stack.getItemID() < ActionbarItem.spellIndex && Item.itemsList[stack.getItemID()] instanceof ItemArmor)
		{
//			TODO: [Tooltip -- broken part 2 (active bonuses)]
...
//			return ((ItemArmor)(Item.itemsList[stack.getItemID()])).getArmorType().getBonusesActivated(player);
	...
	private static String[] getSetBonuses(ItemStack stack)
	{
		...
		if(stack.getItemID() >= Item.itemIndex && stack.getItemID() < ActionbarItem.spellIndex && Item.itemsList[stack.getItemID()] instanceof ItemArmor)
		{
//			TODO: [Tooltip -- broken part 1 (set bonuses)]
...
//			}
	 ...
	 */
	protected static void renderApplicableTooltip(WorldClientEarth world, EntityPlayer player)
	{
	...
	private static void renderItemStackTooltip(EntityPlayer player, ItemStack stack)
	{
		if(player.isInventoryOpen && player.getHeldItem() == null)
		{
			...
			{
				yOffset += 24;
				GL11.glColor4d(color.getColors()[0], color.getColors()[1], color.getColors()[2], 1.0);
			...
			GL11.glColor4d(EnumColor.WHITE.getColors()[0], EnumColor.WHITE.getColors()[1], EnumColor.WHITE.getColors()[2], 1.0);
			...
			for(int i = 1; i < setBonuses.length; i+=2)
			{
				...
				{
					GL11.glColor4d(EnumColor.GRAY.getColors()[0], EnumColor.GRAY.getColors()[1], EnumColor.GRAY.getColors()[2], 1.0);
				}
				else
				{
					GL11.glColor4d(EnumColor.WHITE.getColors()[0], EnumColor.WHITE.getColors()[1], EnumColor.WHITE.getColors()[2], 1.0);
