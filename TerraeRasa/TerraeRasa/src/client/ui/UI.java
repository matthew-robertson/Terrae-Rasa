...
{
	public static void render(ClientUpdate update, WorldClientEarth world, EntityPlayer player, Settings settings)
	{		
	 ...
	 */
	protected static void renderText(WorldClientEarth world, EntityPlayer player)
	{
		if(player.isInventoryOpen)
		{
			GL11.glColor4f(1, 1, 1, 1);
	 ...
	 */
	protected static void craftRecipe(ClientUpdate update, WorldClientEarth world, EntityPlayer player, int index, int xoff, int yoff, int size)
	{
	 ...
	 */
	protected static void adjustSliderPosition(WorldClientEarth world, EntityPlayer player, int adjustment)
	{
