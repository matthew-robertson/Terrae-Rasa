...
public class Commands 
{
	...
	private static void causeStatusEffect(World world, EntityPlayer player, int effectID, int timeSeconds, double power)
	{
...
//						/weather <x> <id> <time_seconds>
						...
						{
							WeatherSnow snow = new WeatherSnow(world, world.getChunk(x), timeSeconds);
							snow.setTicksLeft(timeSeconds * GameEngine.TICKS_PER_SECOND);
